import type { Color, ColorWeight } from "../types/color-types";
...
export const BG: Record<
  Color,
  Record<ColorWeight, `bg-${Color}-${ColorWeight}`>
> = {
  red: {
    50: "bg-red-50",
    100: "bg-red-100",
...
export const TEXT: Record<
  Color,
  Record<ColorWeight, `text-${Color}-${ColorWeight}`>
> = {
  red: {
    50: "text-red-50",
    100: "text-red-100",
...
export const BORDER: Record<
  Color,
  Record<ColorWeight, `border-${Color}-${ColorWeight}`>
> = {
  red: {
    50: "border-red-50",
    100: "border-red-100",
  ...
  taupe: {
    50: "border-taupe-50",
    100: "border-taupe-100",
    200: "border-taupe-200",
    300: "border-taupe-300",
    400: "border-taupe-400",
    500: "border-taupe-500",
    600: "border-taupe-600",
    700: "border-taupe-700",
    800: "border-taupe-800",
    900: "border-taupe-900",
    950: "border-taupe-950",
  },
  mauve: {
    50: "border-mauve-50",
    100: "border-mauve-100",
    200: "border-mauve-200",
    300: "border-mauve-300",
    400: "border-mauve-400",
    500: "border-mauve-500",
    600: "border-mauve-600",
    700: "border-mauve-700",
    800: "border-mauve-800",
    900: "border-mauve-900",
    950: "border-mauve-950",
  },
  mist: {
    50: "border-mist-50",
    100: "border-mist-100",
  ...
  olive: {
    50: "border-olive-50",
    100: "border-olive-100",
    200: "border-olive-200",
    300: "border-olive-300",
    400: "border-olive-400",
    500: "border-olive-500",
    600: "border-olive-600",
    700: "border-olive-700",
    800: "border-olive-800",
    900: "border-olive-900",
    950: "border-olive-950",
  },
};
